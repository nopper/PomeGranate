...
# interessante aggiungere la possibilità di eseguire un reduce logaritmico sui
# dati in input. Abbiamo due opzioni:
# num_reduce = log_<maxfile> (numfile)
# 1) Dare al master la possibilità di splittare il lavoro di reduce su piu
...
# gentilmente si prenderà briga di pushare nel dispatcher altrettanti reducer
# 3) Tenere l'intelligenza sempre sul reducer pero se non vi è la possibilità
